    ...
    <section id="career" className="flex flex-col w-full mt-20 scroll-m-14">
      ...
      <div className="border-y-2">
        <Item
          ...
          works={[
            [
              "<strong>개발팀 빌딩 및 조직 관리</strong><br/>- 채용 프로세스 총괄: 이력서 검토, 후보자 커뮤니케이션, 기술 및 아키텍처 설계 면접 전반을 리딩하여 역량있는 엔지니어링 조직 빌딩<br/>- 목표 수립 및 성과 관리: 분기별 개발팀 목표 수립 및 관리, 애뉴얼 리뷰와 연봉 협상을 통한 평가 및 보상<br/>- 지속가능한 엔지니어링 문화 조성: 사내 기술 스터디, 정기 세미나, 1on1 미팅, 포스트모템 프로세스를 안착시켜 팀의 역량 강화 및 지속적인 회고 문화 확립<br/>- 테크 브랜딩 주도: 회사 브랜딩을 제고하고, 팀과 구성원들이 주도적으로 기술 성과를 외부에 공유할 수 있는 '테크 블로그' 런칭 서포트",
              ...
              "<strong>테크 리더십 및 아키텍처 전환</strong><br/>- 데이터베이스 메이저 업그레이드: Postgres 13 EoL 대응을 위해 Blue/Green 배포 방식을 도입하여, Postgres 16 메이저 업그레이드 수행<br/>- 전사 데이터 분석 인프라 구축: 클라우드 기반 분석 환경 조성을 위해 AWS-GCP 간 Site-to-Site VPN -> GCP Datastream -> BigQuery 로 이어지는 ELT 파이프라인 설계 및 구축<br/>- 인프라 IaC 도입 및 개발환경 개선: Terraform 및 Terragrunt를 도입하여 코드 기반 인프라 관리 체계 구축, AwS ECS 기반의 Preview 환경을 설계, 구축하여 개발 검증 효율성 극대화<br/>- 아키텍처 전환 주도: 시스템 확장성 및 고도화를 위해 Kotlin Spring MSA 구조 전환 리딩<br/>- SaaS 및 인프라 자산 관리: AWS, GCP, Azure, Datadog, Sentry, Claude 등 개발팀 소프트웨어 구독 및 인프라 계약/비용 관리 최적화",
